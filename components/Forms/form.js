...
export default function Form(){
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full px-3">
      ...
      <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="phone-number" type="number"/>
